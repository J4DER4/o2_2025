...
class longestIncreasingSubsequenceSpec extends AnyFlatSpec with Matchers:
    "longestIncreasingSubsequence" should "return a sequence with correct length" in {
        // Test N123
        withClue("Test N123 failed") {
            longestIncreasingSubsequence(ArraySeq(1)).length shouldBe 1
            // example: 1
        } 

        // Test N124
        withClue("Test N124 failed") {
            longestIncreasingSubsequence(ArraySeq(1, 2)).length shouldBe 2
            // example: 1 < 2
        }

        // Test N125
        withClue("Test N125 failed") {
            longestIncreasingSubsequence(ArraySeq(2, 1)).length shouldBe 1
            // example: 2
        }

        // Test N126
        withClue("Test N126 failed") {
            longestIncreasingSubsequence(ArraySeq(3, 2, 1)).length shouldBe 1
            // example: 3
        }

        // Test N127
        withClue("Test N127 failed") {
            longestIncreasingSubsequence(ArraySeq(1, 2, 3)).length shouldBe 3
            // example: 1 < 2 < 3
        }

        // Test N128
        withClue("Test N128 failed") {
            longestIncreasingSubsequence(ArraySeq(4, 3, 2, 1, 5, 1)).length shouldBe 2
            // example: 4 < 5
        }
  
        // Test N129
        withClue("Test N129 failed") {
            longestIncreasingSubsequence(ArraySeq(0, 3, 3, 2, 1, 0, 3, 2, 0, 2, 2, 2, 3, 4, 3, 2, 0, 4, 4, 1, 3, 4, 1, 3, 1, 3, 0, 4, 3, 1, 0, 1, 2)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }

        // Test N130
        withClue("Test N130 failed") {
            longestIncreasingSubsequence(ArraySeq(4, 2, 3, 4, 2, 0, 2, 4, 3, 0, 4, 4, 2, 1, 4, 3, 4, 3, 4, 4, 1, 0, 0, 2, 1, 2, 0, 0, 0, 1, 0, 1)).length shouldBe 4
            // example: 0 < 2 < 3 < 4
        }

        // Test N131
        withClue("Test N131 failed") {
            longestIncreasingSubsequence(ArraySeq(0, 4, 1, 4, 1, 1, 1, 4, 2, 4, 3, 4, 1, 1, 4, 2, 1, 2, 1, 0, 1, 3, 3, 4, 0, 3, 4, 2, 2, 3, 4, 4, 2, 4)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }

        // Test N132
        withClue("Test N132 failed") {
            longestIncreasingSubsequence(ArraySeq(2, 2, 2, 1, 0, 0, 1, 1, 0, 2, 1, 0, 0, 1, 0, 3, 3, 0, 3, 4, 2, 4, 4, 3, 4, 4, 0)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }

        // Test N133
        withClue("Test N133 failed") {
            longestIncreasingSubsequence(ArraySeq(1, 1, 2, 1, 3, 4, 3, 1, 4, 4, 1, 2, 1, 1, 0, 3, 0, 0, 2, 1, 3, 2, 4, 4, 1)).length shouldBe 4
            // example: 1 < 2 < 3 < 4
        }

        // Test N134
        withClue("Test N134 failed") {
            longestIncreasingSubsequence(ArraySeq(3, 4, 0, 4, 0, 3, 2, 1, 3, 1, 4, 2, 0, 1, 2, 4, 0, 1, 4, 1, 2, 0, 3, 4, 0, 4, 2, 1)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }

        // Test N135
        withClue("Test N135 failed") {
            longestIncreasingSubsequence(ArraySeq(3, 2, 1, 0, 3, 3, 3, 1, 2, 1, 2, 0, 4, 0, 3, 2, 4, 1, 4, 2, 4, 2, 4, 2, 4)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }

        // Test N136
        withClue("Test N136 failed") {
            longestIncreasingSubsequence(ArraySeq(0, 2, 4, 3, 1, 3, 3, 4, 2, 4, 2, 4, 4, 2, 3, 4, 2, 4, 1, 3, 3, 4, 2, 1, 0)).length shouldBe 5
            // example: 0 < 1 < 2 < 3 < 4
        }


        // Test N137
        withClue("Test N137 failed") {
            longestIncreasingSubsequence(ArraySeq(0, 0, 2, 2, 0, 0, 2, 1, 0, 4, 0, 3, 4, 0, 4, 1, 1, 1, 4, 1, 3, 3, 4, 3, 1, 0, 2, 1, 1, 2, 0)).length shouldBe 4
            // example: 0 < 2 < 3 < 4
        }
        
        // Test N138
        withClue("Test N138 failed") {
            longestIncreasingSubsequence(ArraySeq(1, 1, 2, 2, 4, 2, 4, 0, 2, 1, 4, 0, 0, 1, 0, 3, 0, 1, 4, 4, 3, 3, 3, 1, 3, 3, 2, 4)).length shouldBe 4
            // example: 1 < 2 < 3 < 4
        }

        // Test N139
        withClue("Test N139 failed") {
            longestIncreasingSubsequence(ArraySeq(2, 1, 7, 1, 5, 6, 9, 1, 3, 2, 9, 9, 7, 4, 9, 4, 7, 7, 2, 7, 2, 5, 9, 1, 0, 1, 3, 6, 8)).length shouldBe 6
            // example: 2 < 3 < 4 < 5 < 6 < 8
        }

        // Test N140
        withClue("Test N140 failed") {
            longestIncreasingSubsequence(ArraySeq(4, 6, 4, 2, 2, 7, 2, 8, 3, 9, 1, 9, 7, 4, 1, 2, 0, 4, 1, 2, 0, 3, 7, 5, 1)).length shouldBe 5
            // example: 4 < 6 < 7 < 8 < 9
        }

        // Test N141
        withClue("Test N141 failed") {
            longestIncreasingSubsequence(ArraySeq(7, 4, 8, 1, 2, 3, 2, 8, 2, 5, 6, 7, 5, 6, 5, 6, 7, 1, 4, 9, 8, 4, 1, 1, 1)).length shouldBe 7
            // example: 1 < 2 < 3 < 5 < 6 < 7 < 9
        }

        // Test N142
        withClue("Test N142 failed") {
            longestIncreasingSubsequence(ArraySeq(9, 9, 5, 9, 5, 2, 9, 4, 2, 1, 9, 9, 0, 3, 2, 7, 9, 3, 8, 0, 0, 8, 9, 8, 6)).length shouldBe 5
            // example: 2 < 4 < 7 < 8 < 9
        }

        // Test N143
        withClue("Test N143 failed") {
            longestIncreasingSubsequence(ArraySeq(0, 2, 1, 3, 1, 7, 2, 6, 3, 2, 6, 4, 7, 3, 7, 6, 0, 5, 8, 6, 6, 5, 4, 8, 8, 3, 7, 8, 6)).length shouldBe 9
            // example: 0 < 1 < 2 < 3 < 4 < 5 < 6 < 7 < 8
        }

        // Test N144
        withClue("Test N144 failed") {
            longestIncreasingSubsequence(ArraySeq(9, 6, 8, 7, 9, 5, 1, 4, 5, 6, 8, 6, 8, 2, 5, 5, 0, 6, 2, 7, 4, 8, 6, 7, 9, 4)).length shouldBe 7
            // example: 1 < 4 < 5 < 6 < 7 < 8 < 9
        }

        // Test N145
        withClue("Test N145 failed") {
            longestIncreasingSubsequence(ArraySeq(8, 9, 9, 4, 7, 8, 1, 2, 6, 2, 3, 9, 5, 0, 6, 5, 4, 5, 7, 9, 1, 1, 0, 6, 6, 0, 6, 1, 7, 2, 0, 8)).length shouldBe 8
            // example: 1 < 2 < 3 < 4 < 5 < 6 < 7 < 8
        }

        // Test N146
        withClue("Test N146 failed") {
            longestIncreasingSubsequence(ArraySeq(2, 9, 4, 4, 4, 9, 9, 9, 4, 6, 0, 6, 2, 8, 9, 3, 9, 2, 1, 3, 0, 0, 0, 5, 4, 1, 9)).length shouldBe 5
            // example: 2 < 4 < 6 < 8 < 9
        }

        // Test N147
        withClue("Test N147 failed") {
            longestIncreasingSubsequence(ArraySeq(2, 5, 4, 3, 2, 4, 9, 6, 0, 8, 6, 1, 6, 2, 8, 7, 7, 8, 2, 7, 7, 3, 3, 1, 4, 5, 1, 0, 7, 4, 0)).length shouldBe 7
            // example: 0 < 1 < 2 < 3 < 4 < 5 < 7
        }

        // Test N148
        withClue("Test N148 failed") {
            longestIncreasingSubsequence(ArraySeq(5, 9, 9, 3, 7, 3, 2, 0, 4, 4, 3, 3, 0, 4, 3, 6, 3, 7, 9, 1, 7, 5, 1, 0, 7, 5, 6, 7, 9, 0)).length shouldBe 7
            // example: 2 < 3 < 4 < 5 < 6 < 7 < 9
        }

        // Test N149
        withClue("Test N149 failed") {
            longestIncreasingSubsequence(ArraySeq(36, 25, 17, 10, 71, 40, 24, 96, 80, 52, 57, 43, 89, 93, 62, 89, 76, 18, 99, 17, 90, 71, 56, 41, 30, 33, 26)).length shouldBe 7
            // example: 36 < 40 < 52 < 57 < 89 < 93 < 99
        }

        // Test N150
        withClue("Test N150 failed") {
            longestIncreasingSubsequence(ArraySeq(61, 20, 48, 99, 19, 80, 54, 63, 34, 65, 43, 69, 84, 46, 23, 45, 3, 58, 19, 89, 36, 90, 69, 78, 4, 58, 85, 14, 55)).length shouldBe 9
            // example: 20 < 48 < 54 < 63 < 65 < 69 < 84 < 89 < 90
        }

        // Test N151
        withClue("Test N151 failed") {
            longestIncreasingSubsequence(ArraySeq(46, 40, 27, 97, 0, 67, 93, 51, 78, 58, 32, 84, 63, 76, 39, 73, 22, 56, 18, 45, 26, 85, 25, 96, 25, 5)).length shouldBe 7
            // example: 46 < 51 < 58 < 63 < 76 < 85 < 96
        }
  
        // Test N152
        withClue("Test N152 failed") {
            longestIncreasingSubsequence(ArraySeq(73, 57, 88, 73, 79, 74, 0, 3, 35, 71, 7, 54, 72, 47, 97, 25, 24, 36, 13, 34, 91, 18, 43, 5, 19, 66, 44, 38, 67, 87)).length shouldBe 9
            // example: 0 < 3 < 7 < 25 < 36 < 43 < 66 < 67 < 87
        }
  
        // Test N153
        withClue("Test N153 failed") {
            longestIncreasingSubsequence(ArraySeq(72, 16, 51, 17, 6, 21, 92, 59, 54, 78, 41, 33, 94, 85, 83, 56, 2, 46, 57, 44, 73, 6, 47, 47, 0)).length shouldBe 7
            // example: 16 < 17 < 21 < 54 < 56 < 57 < 73
        }

        // Test N154
        withClue("Test N154 failed") {
            longestIncreasingSubsequence(ArraySeq(28, 21, 77, 2, 51, 3, 30, 42, 40, 31, 4, 33, 73, 44, 99, 81, 79, 87, 52, 69, 88, 34, 2, 77, 54, 92, 0, 49, 37, 7)).length shouldBe 10
            // example: 2 < 3 < 30 < 31 < 33 < 73 < 81 < 87 < 88 < 92
        }
        // Test N155
        withClue("Test N155 failed") {
            longestIncreasingSubsequence(ArraySeq(18, 55, 34, 4, 80, 41, 74, 69, 48, 15, 52, 40, 43, 37, 64, 82, 77, 1, 15, 65, 44, 92, 47, 50, 99, 8, 7, 54, 88, 76, 27, 11, 84, 28)).length shouldBe 10
            // example: 18 < 34 < 41 < 43 < 44 < 47 < 50 < 54 < 76 < 84
        }

        // Test N156
        withClue("Test N156 failed") {
            longestIncreasingSubsequence(ArraySeq(56, 18, 21, 63, 69, 37, 37, 1, 82, 32, 80, 2, 79, 33, 22, 43, 89, 94, 29, 8, 92, 69, 87, 60, 21, 83, 97, 60)).length shouldBe 8
            // example: 18 < 21 < 63 < 69 < 82 < 89 < 94 < 97
        }

        // Test N157
        withClue("Test N157 failed") {
            longestIncreasingSubsequence(ArraySeq(24, 43, 63, 61, 17, 19, 93, 15, 38, 42, 22, 70, 35, 74, 86, 15, 99, 15, 52, 52, 88, 25, 96, 58, 94, 26)).length shouldBe 9
            // example: 17 < 19 < 38 < 42 < 70 < 74 < 86 < 88 < 96
        }

        // Test N158
        withClue("Test N158 failed") {
            longestIncreasingSubsequence(ArraySeq(55, 10, 62, 61, 24, 83, 63, 48, 75, 62, 68, 76, 58, 63, 29, 99, 55, 92, 36, 89, 69, 32, 71, 10, 42, 5, 38, 24, 63, 88, 38, 79, 17)).length shouldBe 8
            // example: 10 < 24 < 48 < 62 < 68 < 69 < 71 < 88
        }

        // Test N159
        withClue("Test N159 failed") {
            longestIncreasingSubsequence(ArraySeq(56, 66, 12, 85, 64, 72, 81, 23, 10, 65, 26, 39, 50, 32, 27, 51, 20, 38, 5, 15, 87, 41, 86, 52, 51)).length shouldBe 7
            // example: 12 < 23 < 26 < 39 < 50 < 51 < 87
        }

        // Test N160
        withClue("Test N160 failed") {
            longestIncreasingSubsequence(ArraySeq(40, 84, 82, 33, 62, 93, 0, 92, 29, 9, 19, 15, 29, 58, 22, 87, 76, 40, 34, 5, 32, 60, 75, 26, 88, 62, 86, 13, 81, 11, 52, 85, 55, 73)).length shouldBe 9
            // example: 0 < 9 < 19 < 29 < 58 < 60 < 75 < 81 < 85
        }

        // Test N161
        withClue("Test N161 failed") {
            longestIncreasingSubsequence(ArraySeq(21, 8, 61, 52, 19, 86, 68, 60, 21, 61, 94, 92, 39, 91, 11, 61, 81, 31, 59, 86, 88, 69, 62, 97, 66, 47, 97, 48, 67, 66, 12, 84, 23, 49)).length shouldBe 9
            // example: 8 < 19 < 21 < 39 < 61 < 81 < 86 < 88 < 97
        }

        // Test N162
        withClue("Test N162 failed") {
            longestIncreasingSubsequence(ArraySeq(81, 21, 12, 26, 78, 74, 41, 87, 68, 40, 35, 31, 66, 78, 47, 17, 11, 41, 48, 2, 23, 35, 20, 62, 41, 60, 9, 41, 30, 63, 42, 5)).length shouldBe 7
            // example: 21 < 26 < 41 < 47 < 48 < 62 < 63
        }

        // Test N163
        withClue("Test N163 failed") {
            longestIncreasingSubsequence(ArraySeq(57, 14, 86, 73, 57, 79, 57, 27, 42, 48, 38, 57, 86, 30, 57, 68, 24, 29, 39, 73, 98, 63, 15, 90, 5, 14, 20, 16, 69)).length shouldBe 8
            // example: 14 < 27 < 42 < 48 < 57 < 68 < 73 < 98
        }

        // Test N164
        withClue("Test N164 failed") {
            longestIncreasingSubsequence(ArraySeq(74, 55, 44, 0, 53, 62, 4, 81, 25, 39, 78, 83, 45, 99, 95, 6, 55, 67, 69, 41, 45, 70, 45, 29, 78, 47, 45, 19, 52, 3, 45, 31)).length shouldBe 10
            // example: 0 < 4 < 25 < 39 < 45 < 55 < 67 < 69 < 70 < 78
        }

        // Test N165
        withClue("Test N165 failed") {
            longestIncreasingSubsequence(ArraySeq(96, 88, 14, 63, 5, 77, 20, 5, 17, 83, 51, 91, 8, 55, 88, 43, 86, 53, 79, 48, 83, 70, 82, 57, 68, 60, 55, 45, 87)).length shouldBe 7
            // example: 14 < 20 < 51 < 55 < 79 < 83 < 87
        }

        // Test N166
        withClue("Test N166 failed") {
            longestIncreasingSubsequence(ArraySeq(48, 27, 53, 13, 56, 3, 45, 54, 28, 55, 22, 6, 52, 69, 87, 71, 83, 49, 91, 87, 51, 59, 84, 47, 70, 7, 61, 87, 35, 21)).length shouldBe 9
            // example: 48 < 53 < 54 < 55 < 69 < 71 < 83 < 84 < 87
        }

        // Test N167
        withClue("Test N167 failed") {
            longestIncreasingSubsequence(ArraySeq(7, 64, 11, 44, 25, 47, 38, 91, 81, 1, 78, 24, 30, 19, 75, 93, 79, 45, 5, 52, 99, 26, 87, 71, 81, 61, 12, 46)).length shouldBe 8
            // example: 7 < 11 < 25 < 38 < 45 < 52 < 71 < 81
        }

        // Test N168
        withClue("Test N168 failed") {
            longestIncreasingSubsequence(ArraySeq(89, 14, 39, 88, 16, 52, 75, 99, 18, 27, 38, 27, 22, 2, 49, 7, 87, 56, 61, 71, 40, 20, 59, 34, 74, 35, 91, 80, 30, 92)).length shouldBe 12
            // example: 14 < 16 < 18 < 27 < 38 < 49 < 56 < 61 < 71 < 74 < 91 < 92
        }

        // Test N169
        withClue("Test N169 failed") {
            longestIncreasingSubsequence(ArraySeq(883, 891, 317, 948, 520, 219, 357, 292, 436, 510, 300, 623, 436, 165, 227, 459, 678, 324, 621, 856, 551, 741, 232, 782, 867, 281, 388, 482, 552, 458, 3, 319, 544, 509, 69, 874, 457, 203, 975, 342, 682, 6, 575, 565, 36, 104, 166, 80, 2, 462, 842, 829, 55, 548, 71, 616, 667, 251, 634, 661, 41, 277, 546, 193, 728, 289, 435, 472, 892, 290, 264, 776, 353, 802, 476, 549, 227, 843, 333, 166, 108, 766, 142, 13, 659, 237, 464, 988, 277, 106, 428, 619, 715, 891, 807, 542, 104, 997, 579, 442, 173, 845, 245, 704, 283, 726, 712, 426, 269, 28, 518, 251, 175, 295, 94, 995, 622, 427, 183, 104, 62, 612, 143, 136, 114, 775, 744, 947, 435, 900, 128, 165, 880, 136, 195, 689, 999, 886, 135, 329, 37, 261, 92, 242, 184, 981, 70, 668, 438, 723, 384, 527, 945, 245, 991, 289, 634, 663, 416, 508, 30, 283, 391, 941, 809, 710, 309, 622, 222, 175, 261, 750, 209, 844, 219, 894, 857, 885, 9, 228, 421, 897, 368, 676, 634, 943, 559, 714, 718, 461, 827, 661, 812, 660, 251, 133, 564, 29, 319, 653, 926, 300, 397, 460, 571, 682, 847, 797, 129, 306, 76, 454, 697, 369, 697, 349, 886, 752, 108, 750, 964, 741, 573, 250, 346, 301, 570, 874, 453, 767, 677, 105, 443, 210, 92, 375, 441, 222, 940, 562, 185, 744, 83, 54, 876, 143, 897, 605, 984, 539, 970, 258, 254, 733, 475, 943, 651, 857, 670, 559, 344, 673, 931, 30, 760, 971, 117, 148, 613, 491, 607, 344, 96, 547, 673, 473, 483, 94, 731, 680, 836, 972, 932, 313, 161, 63, 479, 257, 803, 173, 923, 73, 825, 150, 134, 400, 529, 117, 477, 591, 492, 516, 707, 813, 959, 872, 291, 819, 370, 491, 779, 914, 527, 856, 503, 464, 433, 713, 15, 626, 87, 516, 127, 339, 379, 636, 977, 115, 611, 964, 376, 459, 923, 158, 411, 444, 636, 922, 781, 311, 989, 850, 61, 351, 725, 370, 271, 627, 210, 533, 38, 439, 522, 154, 564, 546, 107, 405, 127, 467, 865, 874, 378, 84, 548, 717, 893, 321, 170, 205, 826, 90, 544, 447, 958, 115, 361, 798, 143, 836, 752, 399, 288, 597, 760, 227, 678, 922, 814, 286, 478, 660, 703, 669, 878, 479, 172, 252, 612, 560, 270, 661, 447, 951, 943, 221, 824, 698, 111, 384, 276, 402, 655, 397, 241, 366, 486, 276, 266, 365, 46, 579, 945, 194, 426, 32, 360, 752, 886, 329, 437, 532, 483, 919, 559, 90, 558, 745, 313, 320, 739, 621, 50, 335, 691, 97, 381, 487, 295, 232, 36, 170, 96, 400, 293, 601, 261, 727, 318, 474, 312, 174, 362, 475, 542, 70, 480, 665, 96, 823, 868)).length shouldBe 36
